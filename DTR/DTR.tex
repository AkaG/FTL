...
Jeśli zakupiono atmega bez bootloader'a, należy go wgrać lub zdobyć układ z wgranym bootloader'em.
Jest też opcja wgrywanie programu bezpośrednio.
Jeśli układ ma bootload'er należy podłączyć port szeregowy poszczególnymi kabelkami. Znajduje się on po lewej od oscylatora. Wgrywanie przeprowadza się poprzez naciśnięcie wgraj w Arduino IDE.
